...
The Notch Pay for Give allows site owners from West African et Central African countries to accept donations from their customers, anywhere on the Give plugin platform.  
...
= Multiple Channels =
We've done all the heavy lifting such that you can immediately start accepting payments across all channels. Allow your customers make payments via their credit/debit card, Mobile Money.
...
If you get stuck, you can ask for help in the [Notch Pay for Give Plugin Forum](https://wordpress.org/support/plugin/notchpay-for-give). You can also directly email hello@notchpay.co for assistance.
 
= Notch Pay for Give is awesome! Can I contribute? =
